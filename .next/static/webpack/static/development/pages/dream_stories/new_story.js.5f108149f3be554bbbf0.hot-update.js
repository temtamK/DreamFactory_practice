        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              min_down_pirce_wei = _ethereum_web3__WEBPACK_IMPORTED_MODULE_13__["default"].utils.toWei(_this.state.min_down_price, "ether");
              console.log(min_down_pirce_wei); //call createDreamStory of DreamFactory
              //use metamsk's functionality to estimate the gas limit

              _context.next = 10;
              return _ethereum_dream_factory__WEBPACK_IMPORTED_MODULE_12__["default"].methods.createDreamStory(min_down_pirce_wei, _this.state.title, _this.state.story).send({
                from: accounts[0]
              });
...
//# sourceMappingURL=new_story.js.5f108149f3be554bbbf0.hot-update.js.map